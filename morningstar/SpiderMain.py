#!/usr/bin/env python3
from morningstar import HtmlParser as p
...
class SpiderMain(object):
    ...
    def craw_root(self,root_url):
        ...
        result = self.parser._parse_data(root_url, html_content)
...
if __name__ == '__main__':
    spider = SpiderMain()
    # while n <= 30:
    spider.craw_root("http://cn.morningstar.com/quickrank/default.aspx")
    #解析子页面
    # spider.craw()
